...
import { Stack, Button, Typography, Accordion, AccordionDetails, AccordionSummary, Card, useTheme } from "@mui/material";
    ...
    return (
        ...
        <AdminLayout title={patronRequest?.clusterRecord?.title}>
                ...
                <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[0]} onChange={handleAccordionChange(0)}>
                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-general-details" id="request_details_general" 
                        ...
                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 3, sm: 6, md: 9, lg: 12 }}>
                                ...
                                <Grid xs={2} sm={4} md={4}>
                                        <Stack direction={"column"}>
                                                ...
                                                <RenderAttribute attribute={dayjs(patronRequest?.dateCreated).format('YYYY-MM-DD HH:mm')}/>
                                        </Stack>
                                </Grid>
                                <Grid xs={2} sm={4} md={4}>
                                        <Stack direction={"column"}>
                                                ...
                                                <RenderAttribute attribute={dayjs(patronRequest?.dateUpdated).format('YYYY-MM-DD HH:mm')}/>
                                        </Stack>
                                </Grid>
                                <Grid xs={2} sm={4} md={4}>
                                        <Stack direction={"column"}>
                ...
                <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[6]} onChange={handleAccordionChange(6)}>
                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-bib-record" id="request_bib_record" 
                                expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                </IconContext.Provider>}>
                                <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.bib_record")} </Typography>
                        </AccordionSummary>
                        <AccordionDetails>
                                <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 3, sm: 6, md: 9, lg: 12 }}>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        {(bibClusterRecordUrl == '') ? <RenderAttribute attribute={patronRequest?.bibClusterId}/> : <Link href={bibClusterRecordUrl} key="bibClusterRecordLink" target='_blank' rel="noreferrer" title={t("link.discovery_tip")}><RenderAttribute attribute={patronRequest?.bibClusterId}/></Link>}
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.clusterRecord?.title}/>
                                                </Stack>
                                        </Grid>
                                        ...
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.clusterRecord?.members[0]?.author}/>
                                                </Stack>
                                        </Grid>
                                        ) : null}
                                        ...
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={dayjs(patronRequest?.clusterRecord?.dateCreated).format('YYYY-MM-DD HH:mm')}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={dayjs(patronRequest?.clusterRecord?.dateUpdated).format('YYYY-MM-DD HH:mm')}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.clusterRecord?.selectedBib}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.clusterRecord?.members[0]?.sourceRecordId}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.clusterRecord?.sourceSystemId}/>
                                                </Stack>
                                        </Grid>
                                </Grid>
                                <Card variant="outlined">
                                <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[7]} onChange={handleAccordionChange(7)}>
                                <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-source-record" id="request_source_record" 
                                        expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                        </IconContext.Provider>}>
                ...
                <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[1]} onChange={handleAccordionChange(1)}>
                                <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-patron-details" id="request_details_patron" 
                                        expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                        </IconContext.Provider>} >
                                        <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.patron")} </Typography>
                                </AccordionSummary>
                                <AccordionDetails>
                                <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 3, sm: 6, md: 9, lg: 12 }}>
                                <Grid xs={2} sm={4} md={4}>
                                ...
                                <Grid xs={2} sm={4} md={4}>
                                        <Stack direction={"column"}>
                                                ...
                                                <RenderAttribute attribute={patronRequest?.requestingIdentity?.id}/>
                                        </Stack>
                                </Grid>
                                <Grid xs={2} sm={4} md={4}>
                                        <Stack direction={"column"}>
                ...
                <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[2]} onChange={handleAccordionChange(2)}>
                                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-pickup-details" id="request_details_pickup" 
                                                expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                                </IconContext.Provider>}>
                                               <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.pickup")} </Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 3, sm: 6, md: 9, lg: 12 }}>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.pickupLocationCode}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                        ...
                        <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[3]} onChange={handleAccordionChange(3)}>
                                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-supplier-details" id="request_details_supplier" 
                                                expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                                </IconContext.Provider>}>
                                               <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.supplier")} </Typography>
                                        </AccordionSummary>
                                        ...
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localAgency}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                        ...
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.canonicalItemType}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={dayjs(patronRequest?.suppliers[0]?.dateCreated).format('YYYY-MM-DD HH:mm')}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={dayjs(patronRequest?.suppliers[0]?.dateUpdated).format('YYYY-MM-DD HH:mm')}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.hostLmsCode}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={String(patronRequest?.suppliers[0]?.isActive)}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localItemId}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localBibId}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localItemBarcode}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localItemLocationCode}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localItemStatus}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localItemType}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localId}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.suppliers[0]?.localStatus}/>
                                                </Stack>
                                        </Grid>
                                        </Grid>
                                        </AccordionDetails>
                        ...
                        <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[4]} onChange={handleAccordionChange(4)}>
                                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-details-borrowing" id="request_details_borrowing" 
                                                expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                                </IconContext.Provider>}>
                                               <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.borrowing", "Borrowing")} </Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                        <Grid container spacing={{ xs: 2, md: 3 }} columns={{ xs: 3, sm: 6, md: 9, lg: 12 }}>
                                        <Grid xs={2} sm={4} md={4}>
                                        ...
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                                                        ...
                                                        <RenderAttribute attribute={patronRequest?.requestingIdentity?.localPtype}/>
                                                </Stack>
                                        </Grid>
                                        <Grid xs={2} sm={4} md={4}>
                                                <Stack direction={"column"}>
                        ...
                        <Accordion variant="outlined" sx={{border: '0'}} expanded={expandedAccordions[5]} onChange={handleAccordionChange(5)}>
                                        <AccordionSummary sx={{backgroundColor: theme.palette.primary.detailsAccordionSummary}} aria-controls="request-audit_log" id="request_audit_log" 
                                                expandIcon={<IconContext.Provider value={{size: "2em"}}> <MdExpandMore/> 
                                                </IconContext.Provider>}>
                                               <Typography variant="h2" sx={{ fontWeight: 'bold' }}> {t("details.audit_log")} </Typography>
                                        </AccordionSummary>
                                        <AccordionDetails>
                                        <ClientDataGrid 
