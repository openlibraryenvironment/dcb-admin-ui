...
export const Route = createFileRoute("/__authenticated/libraries/libraryId/patronRequests/all")({
...
function PatronRequests() {
	...
	const allVariables = `patronHostlmsCode: ${code}`;
			...
			>
				...
				<Grid size={{ xs: 4, sm: 8, md: 12 }}>
					...
					<ServerPaginationGrid
						...
						presetQueryVariables={allVariables}
						type="patronRequestsLibraryAll"
