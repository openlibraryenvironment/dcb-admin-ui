...
import { defaultPatronRequestLibraryColumnVisibility } from "@helpers/dataGrid/columns";
...
export const Route = createFileRoute("/__authenticated/libraries/libraryId/patronRequests/active")({
...
function PatronRequests() {
	...
	const inProgressQueryVariables = `patronHostlmsCode: "${library?.agency?.hostLms?.code}"AND NOT status:"ERROR" AND NOT status: "NO_ITEMS_SELECTABLE_AT_ANY_AGENCY" AND NOT status: "CANCELLED" AND NOT status: "FINALISED" AND NOT status:"COMPLETED" AND outOfSequenceFlag:false`;
			...
			>
				...
				<Grid size={{ xs: 4, sm: 8, md: 12 }}>
					...
					<ServerPaginationGrid
						...
						columnVisibilityModel={defaultPatronRequestLibraryColumnVisibility}
