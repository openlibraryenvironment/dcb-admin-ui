...
export const Route = createFileRoute("/__authenticated/libraries/libraryId/referenceValueMappings/all")({
	component: All,
});
...
function All() {
	...
	const [subTabIndex, setSubTabIndex] = useState(5);
			...
			>
				...
				<Grid size={{ xs: 4, sm: 8, md: 12 }}>
					...
					<ServerPaginationGrid
						...
						presetQueryVariables={refValueAllVariables}
						type="referenceValueMappingsForLibraryAll"
				...
				{library?.secondHostLms ? (
					<Grid size={{ xs: 4, sm: 8, md: 12 }}>
						...
						<ServerPaginationGrid
							...
							deleteQuery={deleteReferenceValueMapping}
							refetchQuery={["LoadMappings"]}
							presetQueryVariables={refValueAllSecondHostLmsVariables}
							type="referenceValueMappingsForLibraryAllSecondHostLms"
							coreType="referenceValueMappings"
							operationDataType="ReferenceValueMapping"
							columns={refValueMappingColumnsNoCategoryFilter}
							noDataMessage={t("mappings.import_no_data")}
