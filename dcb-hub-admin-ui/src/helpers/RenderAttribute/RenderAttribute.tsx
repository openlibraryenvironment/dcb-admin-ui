...
export default function RenderAttribute({attribute} : any) {
    ...
    return (attribute!=null && attribute!="" && attribute!=undefined ? <Typography variant="attributeText" title={attribute}>{attribute}</Typography> : <Typography variant="attributeText" aria-hidden="true" title={t("a11y.empty")}> - </Typography>);
}