...
export default function ConsortiumDetails() {
    ...
    components={[<abbr title='placeholder content' key={'abbr9'}/>]}
    values={{
        agencies_total: '81',
    ...
    components={[<abbr title='placeholder content' key={'abbr7'}/>]}
    values={{
        hostlmss_total: '51',
        consortium_name: 'MOBIUS'
    }}/>],
    [t('onboarding.stage.configure_services.name'), t('onboarding.stage.configure_services.action'), 
    <Trans key={'configureServices'} i18nKey={'dashboard_consortium_details.row3_col3'} components={[<abbr title='placeholder content' key='abbrevi1'/>]}/>],
    [t('onboarding.stage.migrate_service.name'), t('onboarding.stage.migrate_service.action'),
    <Trans key={'migrateServices'} i18nKey={'dashboard_consortium_details.row4_col3'} components={[<abbr title='placeholder content' key='abbrevi2'/>]}/>],
    [t('onboarding.stage.operate_dcb.name'), t('onboarding.stage.operate_dcb.action'), 
    <Trans key={'operateDCB'} i18nKey={'dashboard_consortium_details.row5_col3'} components={[<abbr title='placeholder content' key='abbrevi3'/>]}/>],
    [t('onboarding.stage.manage_support.name'), t('onboarding.stage.manage_support.action'),
    <Trans key={'manageSupport'} i18nKey={'dashboard_consortium_details.row6_col3'} components={[<abbr title='placeholder content' key='abbrevi4'/>]}/>]];
