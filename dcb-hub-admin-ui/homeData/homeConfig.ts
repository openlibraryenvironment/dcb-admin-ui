...
const REPO_LINKS = {
    ...
    KEYCLOAK: 'https://gitlab.com/knowledge-integration/libraries/dcb-keycloak-extensions'
}
...
const RELEASE_PAGE_LINKS = {
    ...
    KEYCLOAK: 'https://gitlab.com/knowledge-integration/libraries/dcb-keycloak-extensions/-/releases'
}

const ONBOARDING_LINKS = {
  INTRODUCE_LIBRARIES: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2724134932/',
  PROVISION_SYSTEMS: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2724200457/',
  CONFIGURE_SERVICES: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2724134947/',
  MIGRATE_SERVICE: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2724134961/',
  OPERATE_DCB: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2723643452/',
  MANAGE_SUPPORT: 'https://openlibraryfoundation.atlassian.net/wiki/spaces/DCB/pages/2724167720/'
}

export { API_LINKS, LOCAL_VERSION_LINKS, REPO_LINKS, RELEASE_PAGE_LINKS, ONBOARDING_LINKS };